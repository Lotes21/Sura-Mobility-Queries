...
TIPO_VEH,GAMA_VEH,
MARCA,MODELO,NANFAVEH,CONCAT(MARCA,'-',MODELO,'-',NANFAVEH) AS MARCA_MODELO_ANO,TOP100,ZONA_SUCURSAL,SUCURSAL,REGION,REGION_URBE,PROVINCIA,nueva_renov NUEVA_RENOV,nueva_renov2,FLOTA,GRUPO_FLOTA,PER as PERIODO,ANT_VEH,EDAD,EXTRANJERO,
...
TIPO_VEH,GAMA_VEH,
MARCA,MODELO,NANFAVEH,CONCAT(MARCA,'-',MODELO,'-',NANFAVEH),TOP100,SUCURSAL,REGION,REGION_URBE,PROVINCIA,NUEVA_RENOV,NUEVA_RENOV2,FLOTA,GRUPO_FLOTA,PER,ANT_VEH,EDAD,EXTRANJERO,
